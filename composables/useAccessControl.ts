...
export const MENU_PERMISSION_MAP: Record<string, AccessItem> = {
  ...
  "/reports/favorites": { anyOf: ["reports.view", "reports-shop-summary", "reports-products-summary", "report-seller", "reports-clients-summary"] },
  ...
  "/reports/customers": { anyOf: ["reports.view", "reports.customers.view", "report-clients", "reports-clients-summary", "report-client"] },
...
export function firstAllowedRbacRoute(can: (slug: string) => boolean) {
  const candidates = [
    ...
    { path: "/reports", slug: "reports.view" },
    { path: "/reports/shops", slug: "reports.shops.view" },
    { path: "/reports/products", slug: "reports.products.view" },
    { path: "/reports/sellers", slug: "reports.sellers.view" },
    { path: "/reports/customers", slug: "reports.customers.view" },

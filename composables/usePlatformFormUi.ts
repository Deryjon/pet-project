export function usePlatformFormUi() {
  ...
  const selectUi = {
    base: "min-h-[48px] cursor-pointer rounded-2xl border-0 bg-white/90 px-4 py-3 text-[14px] text-slate-700 ring-1 ring-slate-200 outline-none transition focus:bg-white focus:ring-2 focus:ring-teal-400/60",
  ...
  const softSelectUi = {
    base: "min-h-[48px] cursor-pointer rounded-2xl border-0 bg-slate-50 px-4 py-3 text-[14px] text-slate-700 ring-1 ring-slate-200 outline-none transition focus:bg-white focus:ring-2 focus:ring-teal-400/60",
    content: "rounded-2xl border border-slate-200 bg-white/98 p-2 shadow-[0_20px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl",
    item: "cursor-pointer rounded-xl px-3 py-2 text-[14px] text-slate-700 data-[highlighted]:bg-teal-50 data-[highlighted]:text-slate-900",
  };

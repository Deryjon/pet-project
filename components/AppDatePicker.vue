...
<template>
  ...
  >
    <button
      type="button"
      class="group flex h-[54px] items-center justify-between rounded-[18px] border border-white/10 bg-white/[0.06] px-4 text-left text-white outline-none transition hover:border-white/20 hover:bg-white/[0.09] focus:border-[#1f78ff]"
    >
      <span>

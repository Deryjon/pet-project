...
const onSubmit = handleSubmit(async () => {
  ...
  try {
    ...
    if (userType && userType !== "platform") {
      throw new Error("Этот аккаунт не относится к platform admin");
    }
  ...
  <div class="auth-card mx-auto w-full max-w-[480px] text-white">
    <div class="brand-row">
      ...
      <div class="brand-text">
        <span class="brand-eyebrow">Konkurent Platform</span>
        <span class="brand-subtitle">CRM Admin Panel</span>
      </div>
    </div>

    <div class="headline">
      <span class="step-badge">Platform Admin</span>
      <h1>Вход</h1>
      <p>Введите номер телефона и пароль администратора платформы.</p>
    </div>
    ...
    <form class="form-stack" @submit.prevent="onSubmit">
            ...
            <transition name="fade">
              <ul v-if="showDropdown" class="code-menu">
                <li v-for="option in options" :key="option">
                  <button type="button" class="code-item" @click="selectOption(option)">
                    {{ option }}
                  </button>
                </li>
              </ul>
      ...
      <div class="field">
        ...
        >
          <input
            ...
            placeholder="Пароль платформенного администратора"
            class="text-input"
          />
      ...
      >
        <span class="flex items-center justify-center gap-2">
          ...
          {{ loading ? "Входим..." : "Войти в platform" }}
        </span>
      </button>
    </form>
